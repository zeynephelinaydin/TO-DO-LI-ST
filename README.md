...
1. **Dosyaları İndirin:** Bu repository'yi bilgisayarınıza indirin.
2. **HTML Dosyasını Açın:** `index.html` dosyasını bir tarayıcıda açarak uygulamayı görüntüleyin.
3. **Görevlerinizi Ekleyin ve Yönetin:** Görevlerinizi ekleyin, silin ve tümünü temizleyin.
